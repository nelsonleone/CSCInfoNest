...
import PublicAnnouncementsPageMC from "@/components/admin/PublicAnnouncementsPageMC";
...
export default async function Page() {
    const { success, data, error } = await fetchAnnouncementsAction()
