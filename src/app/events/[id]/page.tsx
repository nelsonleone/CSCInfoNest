import { fetchSingleEventAction } from "@/actions/fetch_event.action";
import EventDetailsPage from "@/components/admin/EventDetailsPageMC";
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { success, data, error } = await fetchSingleEventAction(id)
